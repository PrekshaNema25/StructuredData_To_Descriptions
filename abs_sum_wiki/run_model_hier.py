...
class Config:
    ...
    def __init__(self, learning_rate=0.0001, embedding_size=50, hidden_size=100,
               batch_size = 64,max_epochs = 20, max_sequence_length_content = 100, max_sequence_length_field = 15,
               max_sequence_length_title=50, max_sequence_length_query = 20, early_stop=100, outdir="../out/",
               emb_tr=False, feed_previous = 5):
	...
	print ("Config", emb_tr)
        ...
        self.max_sequence_length_field   = max_sequence_length_field
