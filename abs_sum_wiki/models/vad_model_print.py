...
from basic_files.vad_pos_emb import *
...
class BasicAttention:
	...
	_z_labels = tf.unpack(z_labels)
        ...
        loss_per_batch = sequence_loss_logits(outputs, _labels, _weights)
	loss_per_sw_batch = sequence_loss_sw(z, _z_labels, _weights)

        self.calculated_loss =  1*loss_per_batch + 9*loss_per_sw_batch
